  ...
  return (
    <>
      <ToastContainer
        ...
        style={{ zIndex: 100 }}
      />
      <div className="fixed inset-0 z-75 overflow-y-auto backdrop-blur-lg">
        <div className="min-h-screen p-4 flex items-center justify-center">
          <div className="flex flex-col max-w-md w-full pt-4 px-6 pb-8 bg-white/90 rounded-2xl shadow-lg">
            <button
              onClick={onClose}
              className="text-black hover:text-gray-700 text-3xl cursor-pointer self-end"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-200/60 placeholder-gray-600/70 border border-gray-200 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center text-black/90">
                  <input
                    ...
                    className="h-4 w-4 text-purple-600 bg-white border-white rounded focus:ring-transparent"
                  />
            ...
            <button
              type="button"
              className="mt-4 flex items-center bg-gray-300/30 hover:bg-gray-200/30 cursor-pointer justify-center w-full py-3 border border-white/70 rounded-lg text-black/90 transition font-semibold"
            >
