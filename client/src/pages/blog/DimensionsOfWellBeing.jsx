    ...
    <div className="w-full pt-24 px-4 md:px-10">
      <div className="max-w-4xl flex flex-col justify-center items-center mx-auto p-8 rounded-2xl bg-white/40 border border-white/60 shadow-sm">
        ...
        <p className="text-lg leading-relaxed mb-6">
          Mental health is influenced by more than just our thoughts and
          emotions. It is deeply connected to the different{" "}
          <span className="font-semibold">pillars of our daily lives</span>,
          including <span className="font-medium">social connection</span>,{" "}
          <span className="font-medium">physical health</span>,{" "}
          <span className="font-medium">emotional well-being</span>,{" "}
          <span className="font-medium">career fulfillment</span>,{" "}
          <span className="font-medium">financial stability</span>,{" "}
          <span className="font-medium">personal growth</span>, and{" "}
          <span className="font-medium">spiritual alignment</span>. Each of
          these areas plays a unique role in shaping how we feel, think, and
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          When our work aligns with our values, we feel more purpose and
          motivation. Managing finances wisely reduces stress and gives us peace
          of mind. Moments of personal growth and self-reflection help us feel
          capable and confident. And for many, spiritual practices offer deeper
          meaning and inner peace.
        </p>

        <p className="text-lg leading-relaxed mb-6">
          These dimensions do not operate separately. They are{" "}
          <span className="font-medium">interconnected</span>. A positive change
          in one area often uplifts others. For example, getting better sleep
          can improve emotional regulation and decision-making. Feeling
          supported socially can motivate someone to exercise more. This is why
          maintaining a balanced approach to life (even in small steps) can make
        ...
        <p className="text-sm leading-relaxed italic text-gray-700 border-t pt-6">
          At <span className="font-medium">MoodSync</span>, we believe mental
